...
class GuiRoot(QWidget):
    ...
    def __init__(self, dataset):
        ...
        self.center()
        self.setWindowTitle('FuzzyCarSystem')
        self.show()
        self.datalist = dataset.keys()
        self.data = dataset
        #واجهة لاختيار الخريطة
    ...
    def file_run_creation(self, datalist):
        self.file_run = QGroupBox("Map choose")
        layout = QGridLayout()
    ...
    def semantic_rule_setting_creation(self):
        ...
        self.variable_table.setItem(2, 0, QTableWidgetItem("Left-Right dist."))
        self.variable_table.setItem(3, 0, QTableWidgetItem("car rotation angle "))
    ...
    def fuzzy_rule_setting_creation(self):
        ...
        self.table.setItem(2, 0, QTableWidgetItem("car rotation angle "))
        """fill the table"""
        for i in range(3):
